                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <?php echo form_open_multipart ("adminLogin/validarusuario"); ?>
                                    <form class="user">
                                        <div class="form-group">
                                             <input type="email"  class="form-control" name="login" placeholder="Escribe login" required>
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="text-center">
                                        <a class="small" href="<?php echo base_url(); ?>index.php/administrador/agregar">Crear nueva Cuenta!</a>
                                    </div>r
                                </div>
                            </div>
                        </div>
