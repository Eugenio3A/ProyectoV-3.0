                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4"> BIEN VENIDO! Conductor</h1>
                                    </div>
                                    

                                    <?php echo form_open_multipart ("conductorLogin/validarusuario"); ?>
                                    <form class="user">
                                        <br>
                                    ...
                                    <div class="text-center">
                                        <a class="small" href="<?php echo base_url(); ?>index.php/conductor/agregar">Crear nueva Cuenta!</a>
                                    </div>
                                </div>
                            </div>
                        </div>
